...
{
    public partial class CAMBIO_DE_ESTADO : Form
    {
        ...
        public CAMBIO_DE_ESTADO()
        {
            InitializeComponent();
        }

        private void CAMBIO_DE_ESTADO_Load(object sender, EventArgs e)
        {
            this.leer_datos("SELECT * FROM PERSONA", ref resultado, "PERSONA");
        ...
        private void cambio_estado_Click(object sender, EventArgs e)
        {
